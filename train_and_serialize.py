...
This will train a classifier on unambiguous data and serialize it to file with sklearn.joblib
...
train_and_serialize(sys.argv[1], sys.argv[2], models.OptionAwareNaiveBayesLeftRight, window_size=20)
